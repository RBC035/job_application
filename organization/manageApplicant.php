<?php include_once "topHeader.php"; ?>
            ...
            <div class='container-fluid mt-5'>
                ...
                <div class="col-md-2 text-end">
                    <button style="background-color:cyan;" onclick="downloadCSV()" class="btn btn-download rounded-1">Download CSV</button>
                        ...
                        <table class='table table-hover table-bordered mt-1' id="post-table">
                          ...
                          <tbody>
                            <?php
                              $no =  1;
                              $app = mysqli_query($con,"select a.*, p.*, s.* , ac.* from application a JOIN post p ON a.postId = p.postID  JOIN applicant s ON a.applicantEmail = s.email JOIN academicQualification ac ON s.email = ac.applicantEmail where p.officeName = '".$profile['officeName']."' order by ac.gpa desc; ");
                              ...
                              <tr>
                                      ...
                                      <td><?php echo $query['email']; ?> </td>
                                        ...
                                        <td class='text-center'>
                                          <a class="btn btn-info border-0" href="../app/applicationHandler.php?appId=<?php  echo $query['id']; ?>"  >Confirm</a>
                                          
                                        </td>
                                        <td class='text-center'>
                                         <a class="btn btn-danger border-0" href="../app/applicationHandler.php?appCancel=<?php  echo $query['id']; ?>"  >Cancel</a>
