                        ...
                        <div class="col-md-5">
                            <div class="card border-0 shadow-sm rounded-0">
                                <div class="card-body">
                                         ...
                                         <p class="lead text-center font-f">Register professional qualification</p>
                                         ...
                                         <form action="../app/qualificationHandler.php" class='px-3' method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="course" class="form-control rounded-1"   />
                                            </div>
                                            ...
                                            <div class="input-group mb-4">
                                                <input type="submit" name="addProfessional" class="form-control btn bg-info-2 rounded-1" value='Save' style="background-color:rgba(255, 93, 69, 0.6);"/>
                                            </div>
                                        </form>
