                            ...
                            <div class="card border-0 shadow-sm rounded-0">
                                <div class="card-body">
                                         ...
                                         <form action="../app/qualificationHandler.php" class='px-3' method="post"  enctype="multipart/form-data">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="program" class="form-control rounded-1"   />
                                            </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="tel" name="gpa" class="form-control rounded-1"  />
                                            </div>
                                            ...
                                            <div class="input-group mb-4">
                                                <input type="submit" name="addAcademic" class="form-control btn bg-info-2 rounded-1" value='Save' style="background-color:rgba(255, 93, 69, 0.6);"/>
                                            </div>
                                        </form>
